...
//    {
//        //public ICoffeeBase CoffeeName(Coffee coffee) => throw new System.NotImplementedException();
//    }
...
//            //ICoffee espresso = new FluentCoffee().CoffeeName(Coffee.Espresso).AddBeans(Beans.Liberia).GrindBeans(true).BaseWater(30).AddWater(20);
